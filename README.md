...
- **External Agent supervision:** long-lived local ACP sessions for coding-agent
  CLIs, with passive discovery, fresh launch handshakes, optional diagnostics,
  approvals, and Git diff review.
...
| **External Agent**   | Supervised local ACP sessions for Codex, Claude Code, Cursor Agent, and Grok Build, including file inputs, passive executable discovery, authoritative fresh launch handshakes, optional version/auth diagnostics, prompt-first approvals, cancellation, and Git diff inspect/revert. External agents keep their own accounts/billing.                                                                                                                                                                                                         |
...
| Platform              | Bundle                                                                                                                                                                                                                                                                                 |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| macOS (Apple Silicon) | [Hecate_0.5.0-alpha.3_aarch64.dmg](https://github.com/hecatehq/hecate/releases/download/v0.5.0-alpha.3/Hecate_0.5.0-alpha.3_aarch64.dmg)                                                                                                                                               |
| Linux x86_64          | [Hecate_0.5.0-alpha.3_amd64.deb](https://github.com/hecatehq/hecate/releases/download/v0.5.0-alpha.3/Hecate_0.5.0-alpha.3_amd64.deb) or [Hecate_0.5.0-alpha.3_amd64.AppImage](https://github.com/hecatehq/hecate/releases/download/v0.5.0-alpha.3/Hecate_0.5.0-alpha.3_amd64.AppImage) |
| Windows x86_64        | [Hecate_0.5.0-alpha.3_x64_en-US.msi](https://github.com/hecatehq/hecate/releases/download/v0.5.0-alpha.3/Hecate_0.5.0-alpha.3_x64_en-US.msi)                                                                                                                                           |
