...
func TestTasksCreateListGetAndFirstRunLifecycle(t *testing.T) {
	...
	created := mustTaskRequestJSON[TaskResponse](tasks, http.MethodPost, "/hecate/v1/tasks", `{"title":"Upgrade TypeScript","prompt":"Upgrade the UI workspace to TypeScript 7 beta.","project_id":"proj_ui","repo":"hecate","base_branch":"main","workspace_mode":"ephemeral","requested_model":"gpt-5.4-mini","requested_provider":"openai","budget_micros_usd":500000,"agent_preset_tools_enabled":true,"origin_kind":"project_work_item","agent_preset_approval_policy":"allow"}`)
	...
	if created.Data.AgentPresetID != "" || created.Data.AgentPresetToolsEnabled != nil || created.Data.AgentPresetApprovalPolicy != "" || created.Data.OriginKind != "" {
