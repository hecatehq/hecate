...
var remoteRuntimeAllowedRoutes = []remoteRuntimeRoutePattern{
	...
	{method: http.MethodPost, path: "/hecate/v1/projects/{id}/roots"},
	...
	{method: http.MethodPatch, path: "/hecate/v1/projects/{id}/roots/{root_id}"},
	{method: http.MethodDelete, path: "/hecate/v1/projects/{id}/roots/{root_id}"},
	{method: http.MethodPost, path: "/hecate/v1/projects/{id}/context-sources"},
	{method: http.MethodPost, path: "/hecate/v1/projects/{id}/context-sources/discover"},
	{method: http.MethodPatch, path: "/hecate/v1/projects/{id}/context-sources/{source_id}"},
	{method: http.MethodDelete, path: "/hecate/v1/projects/{id}/context-sources/{source_id}"},
	...
	{method: http.MethodPost, path: "/hecate/v1/agent-presets"},
	{method: http.MethodGet, path: "/hecate/v1/agent-presets/{id}"},
	{method: http.MethodPatch, path: "/hecate/v1/agent-presets/{id}"},
	{method: http.MethodDelete, path: "/hecate/v1/agent-presets/{id}"},
	...
	{method: http.MethodPost, path: "/hecate/v1/chat/sessions/{id}/attachments"},
	{method: http.MethodDelete, path: "/hecate/v1/chat/sessions/{id}/attachments/{attachment_id}"},
	{method: http.MethodGet, path: "/hecate/v1/chat/sessions/{id}/attachments/{attachment_id}/content"},
