...
func TestRemoteRuntimeLocalEndpointGuardMiddleware(t *testing.T) {
	tests := []struct {
		...
		{name: "allows task schedule list", enabled: true, method: http.MethodGet, path: "/hecate/v1/task-schedules", want: http.StatusNoContent},
		{name: "allows task schedule get", enabled: true, method: http.MethodGet, path: "/hecate/v1/tasks/task_1/schedule", want: http.StatusNoContent},
		{name: "allows task schedule put", enabled: true, method: http.MethodPut, path: "/hecate/v1/tasks/task_1/schedule", want: http.StatusNoContent},
		{name: "allows task schedule delete", enabled: true, method: http.MethodDelete, path: "/hecate/v1/tasks/task_1/schedule", want: http.StatusNoContent},
		{name: "allows task schedule occurrences", enabled: true, method: http.MethodGet, path: "/hecate/v1/tasks/task_1/schedule/occurrences", want: http.StatusNoContent},
