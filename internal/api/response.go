...
const (
	...
	errCodeAgentExecutableTrustRequired       = "agent_adapter.executable_trust_required"
	errCodeAgentExecutableIdentityChanged     = "agent_adapter.executable_identity_changed"
	errCodeAgentExecutableIdentityUnavailable = "agent_adapter.executable_identity_unavailable"
...
func defaultErrorUserMessage(code string) string {
	...
	case errCodeAgentExecutableTrustRequired:
		return "Approve this external-agent app before Hecate runs it."
	case errCodeAgentExecutableIdentityChanged:
		return "This external-agent app changed after approval."
	case errCodeAgentExecutableIdentityUnavailable:
		return "Hecate could not verify this external-agent app."
...
func defaultErrorAction(code string) string {
	...
	case errCodeAgentExecutableTrustRequired:
		return "Open Connections, review the measured executable identity, and approve it."
	case errCodeAgentExecutableIdentityChanged:
		return "Open Connections, review the new executable identity, and approve it again if expected."
	case errCodeAgentExecutableIdentityUnavailable:
		return "Check the app installation and filesystem permissions, then refresh Connections."
	case errCodeSessionStopping:
