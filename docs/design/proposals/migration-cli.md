...
> **Current source of truth:** [Deployment](../../operator/deployment.md) and
> [Known limitations](../../operator/known-limitations.md) for today's backup/upgrade
> guidance.
...
`docs/operator/known-limitations.md` flags two related gaps under "API And
Schema Stability":
