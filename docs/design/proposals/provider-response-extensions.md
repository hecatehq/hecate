...
> **Current source of truth:** [Providers](../../operator/providers.md) and the
...
Listed in [`docs/operator/known-limitations.md`](../../operator/known-limitations.md) under
"Provider Lifecycle":
...
| Docs                                | drop the citations bullet in `known-limitations.md`; add a "Vendor response extensions" section to `docs/operator/providers.md` | ~30           |
...
- `docs/operator/known-limitations.md`'s "Provider-specific response
