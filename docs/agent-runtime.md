...
| `read_file`     | Read a file under the workspace, optionally by line range            | Ungated by default; gate with `read_file` or `all_tools` policy. Path must resolve within the sandbox root                                                                                                                                                                |
| `grep`          | Search workspace text files with a bounded regular-expression search | Ungated by default; gate with `read_file` or `all_tools` policy. Path must resolve within the sandbox root                                                                                                                                                                |
| `glob`          | Find workspace paths by glob pattern                                 | Ungated by default; gate with `read_file` or `all_tools` policy. Path must resolve within the sandbox root                                                                                                                                                                |
