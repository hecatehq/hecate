...
```yaml
# docker-compose.yml
image: ghcr.io/hecatehq/hecate:0.4.0-alpha.1
```
...
curl -LO https://github.com/hecatehq/hecate/releases/download/v0.4.0-alpha.1/hecate_0.4.0-alpha.1_linux_amd64.tar.gz
tar -xzf hecate_0.4.0-alpha.1_linux_amd64.tar.gz
./hecate serve
```
...
Available tarballs for `v0.4.0-alpha.1`:

- `hecate_0.4.0-alpha.1_linux_amd64.tar.gz`
- `hecate_0.4.0-alpha.1_linux_arm64.tar.gz`
- `hecate_0.4.0-alpha.1_darwin_amd64.tar.gz`
- `hecate_0.4.0-alpha.1_darwin_arm64.tar.gz`
