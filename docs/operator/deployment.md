...
```yaml
# docker-compose.yml
image: ghcr.io/hecatehq/hecate:0.5.0-alpha.4
```
...
curl -LO https://github.com/hecatehq/hecate/releases/download/v0.5.0-alpha.4/hecate_0.5.0-alpha.4_linux_amd64.tar.gz
tar -xzf hecate_0.5.0-alpha.4_linux_amd64.tar.gz
./hecate serve
```
...
Available tarballs for `v0.5.0-alpha.4`:

- `hecate_0.5.0-alpha.4_linux_amd64.tar.gz`
- `hecate_0.5.0-alpha.4_linux_arm64.tar.gz`
- `hecate_0.5.0-alpha.4_darwin_amd64.tar.gz`
- `hecate_0.5.0-alpha.4_darwin_arm64.tar.gz`
