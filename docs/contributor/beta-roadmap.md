...
| Project orchestration    | Projects provide the operator cockpit for project-scoped agent teams: roles, work items, assignments, native task launches with frozen Work policy enforcement, structured handoffs, activity health, memory candidates, and context readiness stay linked without replacing Tasks or Chats. |
