...
| RFC                                                                                       | Status                                                                                               | Next action                                                                                        |
| ----------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| [CLI structure](cli-structure.md)                                                         | Proposed. `cmd/hecate/main.go` still uses a hand-written switch for `mcp-server`.                    | Land the dispatcher + `hecate status` + `mcp serve` rename together; sequence everything else.     |
