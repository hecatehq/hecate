...
This audit reviews the remaining RFCs in `docs/rfcs/` (excluding the `README.md`
...
| [hecate-chat-model-capabilities.md](hecate-chat-model-capabilities.md)                       | Accepted (partially implemented) | Hecate Chat + Hecate Agent + observed model capability metadata.          | Keep header as `Accepted`; leave in place.                                                                      |
