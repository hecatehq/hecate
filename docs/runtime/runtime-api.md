...
```json
{
  ...
  "data": {
    ...
    "warnings": [
      ...
      "Project metadata/default-root updates still write Hecate-native stores first, then best-effort mirror through Cairnline's project-metadata and project-defaults seams; provider/model/preset posture stays in Hecate runtime overlays.",
