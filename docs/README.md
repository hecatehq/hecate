...
| [Local models](local-models.md)           | Hecate-managed llama.cpp runtime: bundled binary, Hugging Face installs, runtime lifecycle, storage layout, and troubleshooting.               |
