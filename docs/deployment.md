...
```yaml
# docker-compose.yml
image: ghcr.io/hecatehq/hecate:0.1.0-alpha.29
```
...
curl -LO https://github.com/hecatehq/hecate/releases/download/v0.1.0-alpha.29/hecate_0.1.0-alpha.29_linux_amd64.tar.gz
tar -xzf hecate_0.1.0-alpha.29_linux_amd64.tar.gz
./hecate
```
...
Available tarballs for `v0.1.0-alpha.29`:

- `hecate_0.1.0-alpha.29_linux_amd64.tar.gz`
- `hecate_0.1.0-alpha.29_linux_arm64.tar.gz`
- `hecate_0.1.0-alpha.29_darwin_amd64.tar.gz`
- `hecate_0.1.0-alpha.29_darwin_arm64.tar.gz`
