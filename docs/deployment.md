...
```yaml
# docker-compose.yml
image: ghcr.io/chicoxyzzy/hecate:0.1.0-alpha.13
```
...
curl -LO https://github.com/chicoxyzzy/hecate/releases/download/v0.1.0-alpha.13/hecate_0.1.0-alpha.13_linux_amd64.tar.gz
tar -xzf hecate_0.1.0-alpha.13_linux_amd64.tar.gz
./hecate
```
...
Available tarballs for `v0.1.0-alpha.13`:

- `hecate_0.1.0-alpha.13_linux_amd64.tar.gz`
- `hecate_0.1.0-alpha.13_linux_arm64.tar.gz`
- `hecate_0.1.0-alpha.13_darwin_amd64.tar.gz`
- `hecate_0.1.0-alpha.13_darwin_arm64.tar.gz`
