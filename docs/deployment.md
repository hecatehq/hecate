...
```yaml
# docker-compose.yml
image: ghcr.io/chicoxyzzy/hecate:0.1.0-alpha.16
```
...
curl -LO https://github.com/chicoxyzzy/hecate/releases/download/v0.1.0-alpha.16/hecate_0.1.0-alpha.16_linux_amd64.tar.gz
tar -xzf hecate_0.1.0-alpha.16_linux_amd64.tar.gz
./hecate
```
...
Available tarballs for `v0.1.0-alpha.16`:

- `hecate_0.1.0-alpha.16_linux_amd64.tar.gz`
- `hecate_0.1.0-alpha.16_linux_arm64.tar.gz`
- `hecate_0.1.0-alpha.16_darwin_amd64.tar.gz`
- `hecate_0.1.0-alpha.16_darwin_arm64.tar.gz`
