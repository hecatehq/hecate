...
```yaml
# docker-compose.yml
image: ghcr.io/hecatehq/hecate:0.1.0-alpha.24
```
...
curl -LO https://github.com/hecatehq/hecate/releases/download/v0.1.0-alpha.24/hecate_0.1.0-alpha.24_linux_amd64.tar.gz
tar -xzf hecate_0.1.0-alpha.24_linux_amd64.tar.gz
./hecate
```
...
Available tarballs for `v0.1.0-alpha.24`:

- `hecate_0.1.0-alpha.24_linux_amd64.tar.gz`
- `hecate_0.1.0-alpha.24_linux_arm64.tar.gz`
- `hecate_0.1.0-alpha.24_darwin_amd64.tar.gz`
- `hecate_0.1.0-alpha.24_darwin_arm64.tar.gz`
