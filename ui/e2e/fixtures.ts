...
export const MOCK_AGENT_ADAPTERS = [
  {
    ...
    description:
      "Run Codex through the standalone Go ACP adapter as an external coding-agent session supervised by Hecate.",
    cost_mode: "external",
    docs_url: "https://github.com/hecatehq/codex-acp-adapter",
  },
  {
    id: "claude_code",
    name: "Claude Code",
