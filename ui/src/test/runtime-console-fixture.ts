...
export type RuntimeConsoleFixtureActions = {
  ...
  upsertModelCapabilityOverride: (payload: unknown) => Promise<boolean>;
  recordModelCapabilityProbe: (payload: unknown) => Promise<boolean>;
  deleteModelCapabilityOverride: (provider: string, model: string) => Promise<boolean>;
