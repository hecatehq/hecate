...
import type { AgentAdapterRecord, AgentChatActivityRecord, AgentChatChangedFileDiffRecord, AgentChatChangedFileRecord, AgentChatSessionRecord, AgentChatUsageRecord } from "../../types/runtime";
...
function MessageRow({ id, role, model, content, time, promptTokens, completionTokens, costUsd, badge, runtimeMeta, activities, diffStat, diff, agentSessionID, onListAgentFiles, onGetAgentFileDiff, onRevertAgentFiles, rawOutput, agentUsage, error, onCopy, copied }: {
  ...
  activities?: AgentChatActivityRecord[]; diffStat?: string; diff?: string; agentSessionID?: string;
