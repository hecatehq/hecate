...
export function AgentSetupHints({ adapters, selectedID }: { adapters: AgentAdapterRecord[]; selectedID?: string }) {
  ...
  switch (adapter.id) {
    ...
    default:
      return {
        ...
        commands: adapter.command ? [{ label: "Check", command: `${adapter.command} --version` }] : [],
      };
  }
}
