...
- **Run start and cancellation own their concurrency boundaries.** Start,
  retry, resume, continue, and retry-from-turn serialize per task in the runner,
